...
param_space['SNGNN'] = {
    ...
    'dotval':[1,5,10,20,30,50],
    'p':[(0.1, 0.6), (0.1, 0.7), (0.1, 0.8), (0.1, 0.9), (0.2, 0.6), (0.2, 0.7), (0.2, 0.8), (0.2, 0.9), \
        (0.3, 0.6), (0.3, 0.7), (0.3, 0.8), (0.3, 0.9), (0.4, 0.6), (0.4, 0.7), (0.4, 0.8), (0.4, 0.9)]
}
param_space['MLP'] = {
    'h_feats': [16, 32, 64],
    'num_layers': [1, 2, 3, 4],
