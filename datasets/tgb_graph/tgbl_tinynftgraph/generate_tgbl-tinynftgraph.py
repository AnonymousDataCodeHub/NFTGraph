...
dataset_name = 'tgbl-tinynftgraph'
...
ng_gen = NegativeEdgeGenerator(dataset_name='tgbl-tinynftgraph',first_dst_id=0,last_dst_id=19999,strategy='hist_rnd',historical_data=train_graph,num_neg_e=20)

ng_gen.generate_negative_samples(data, 'val', partial_path=prefix+'/datasets/tgb_graph/tgbl_tinynftgraph')
ng_gen.generate_negative_samples(data, 'test', partial_path=prefix+'/datasets/tgb_graph/tgbl_tinynftgraph')