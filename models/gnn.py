...
class GraphSAGE(nn.Module):
    def __init__(self, in_feats, h_feats=64, num_classes=2, num_layers=2, agg='pool', dropout_rate=0,
                 activation='ReLU',mlp_layers=2, **kwargs):
        ...
        self.mlp =  MLP(h_feats,h_feats, num_classes, mlp_layers-1, dropout_rate,activation='Sigmoid')
        # self.output_linear = nn.Linear(h_feats, num_classes)
        self.dropout = nn.Dropout(dropout_rate) if dropout_rate > 0 else nn.Identity()
